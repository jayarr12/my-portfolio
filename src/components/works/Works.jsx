  ...
  const data = [
    {
      ...
      desc:
        "Create a custom theme or sub-theme. ",
      img:
    ...
    },
    {
      ...
      desc:
        "Build a custom functionality and feature by creating custom module. ",
      img:
    ...
    },
    {
      ...
      desc:
        "Collection of admin settings that determine how the site functions, as opposed to the content of the site. ",
      img:
